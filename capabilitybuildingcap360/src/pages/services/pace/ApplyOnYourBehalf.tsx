...
const CareerTransition = () => {
  ...
  const solutions = [
    {
      icon: Rocket,
      title: "Daily Application Management",
      content: (
        <>
    ...
    {
      icon: Users,
      title: "Multi-Platform Portal Management",
      content: (
        <>
          <p className="text-muted-white leading-relaxed mb-4">
    ...
    {
      icon: Heart,
      title: "Ongoing Search Support & Guidance",
      content: (
        <>
          <p className="text-muted-white leading-relaxed mb-4">
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="text-[28px] md:text-[36px] font-bold mb-12 max-w-3xl">
            How consistency, precision and scale are transforming{" "}
