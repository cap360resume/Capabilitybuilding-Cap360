...
const CareerTransition = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Rocket className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-green" />, title: "Faster career transitions", desc: "Comprehensive outplacement that helps people find new roles faster with professional coaching and job search support." },
    { icon: <Users className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-green" />, title: "Maximised internal mobility", desc: "Skills-based matching that retains valuable talent by redeploying affected employees to open internal roles." },
    { icon: <Heart className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-green" />, title: "Protected employer brand", desc: "Compassionate transition support that preserves your reputation as a responsible, caring employer." },
    { icon: <Shield className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-green" />, title: "Reduced legal risk", desc: "Properly managed transitions that minimise the risk of disputes and protect organisational interests." },
    { icon: <BarChart3 className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-green" />, title: "Maintained team morale", desc: "Visible support for departing colleagues that reassures remaining employees and maintains productivity." },
  ];
