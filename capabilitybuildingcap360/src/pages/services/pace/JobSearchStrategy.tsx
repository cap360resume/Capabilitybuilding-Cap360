...
const JobSearchStrategy = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Compass className="w-8 h-8 text-cap-green" />, title: "Purposeful search focus", desc: "A clearly defined target removes wasted effort and channels energy into roles that genuinely fit." },
    { icon: <Map className="w-8 h-8 text-cap-green" />, title: "Expanded opportunity set", desc: "Industry and role mapping surfaces opportunities candidates would never have found searching alone." },
    { icon: <TrendingUp className="w-8 h-8 text-cap-green" />, title: "Higher application conversion", desc: "Targeted, tailored applications consistently outperform high-volume spray-and-pray approaches." },
    { icon: <BarChart3 className="w-8 h-8 text-cap-green" />, title: "Sustained search momentum", desc: "Structured tracking tools keep energy and progress consistent across a multi-week search." },
    { icon: <Users className="w-8 h-8 text-cap-green" />, title: "Hidden market access", desc: "Referral and targeting strategies open doors to roles that never appear on public job boards." },
  ];
