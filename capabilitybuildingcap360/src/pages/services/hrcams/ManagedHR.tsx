...
const ManagedHR = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Settings className="w-8 h-8 text-cap-yellow" />, title: "End-to-end employee lifecycle management", desc: "Manage the complete employee journey—from onboarding to exit—with structured processes, documentation, and consistent employee experience." },
    { icon: <ClipboardList className="w-8 h-8 text-cap-yellow" />, title: "Seamless PMS administration", desc: "Ensure smooth execution of performance cycles through goal tracking, review coordination, calibration support, and outcome documentation." },
    { icon: <Shield className="w-8 h-8 text-cap-yellow" />, title: "Proactive compliance & policy management", desc: "Monitor statutory compliance, manage policy updates, and ensure adherence to labour laws through structured, ongoing governance." },
    { icon: <BarChart3 className="w-8 h-8 text-cap-yellow" />, title: "Governance reporting & insights", desc: "Provide leadership with structured HR dashboards covering headcount, attrition, compliance status, and workforce trends." },
    { icon: <Headphones className="w-8 h-8 text-cap-yellow" />, title: "Flexible & scalable HR support", desc: "Access tailored HR engagement models—from advisory to fully managed outsourcing—designed to scale with your business needs." },
  ];
