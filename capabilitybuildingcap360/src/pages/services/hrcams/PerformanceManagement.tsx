...
const PerformanceManagement = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Target className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Strategic goal alignment", desc: "Cascade business objectives into individual goals with clear ownership and measurable outcomes." },
    { icon: <BarChart3 className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Data-driven evaluations", desc: "Replace subjective reviews with analytics-backed performance assessments and calibration." },
    { icon: <Users className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Coaching-led culture", desc: "Transform managers into performance coaches who drive continuous development conversations." },
    { icon: <Award className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Fair reward differentiation", desc: "Link performance outcomes to compensation, promotions, and development opportunities transparently." },
    { icon: <Sliders className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Continuous improvement", desc: "Build feedback loops that enable real-time course correction and sustained high performance." },
  ];
