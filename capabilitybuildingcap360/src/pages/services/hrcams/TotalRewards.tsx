...
const TotalRewards = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <DollarSign className="w-8 h-8 text-cap-yellow" />, title: "Market-competitive compensation", desc: "Pay structures benchmarked against industry standards to attract and retain the right talent." },
    { icon: <PieChart className="w-8 h-8 text-cap-yellow" />, title: "Performance-linked pay", desc: "Variable pay programmes that directly connect rewards to individual and business performance." },
    { icon: <Heart className="w-8 h-8 text-cap-yellow" />, title: "Holistic benefits design", desc: "Comprehensive benefits architecture covering health, financial wellness, and lifestyle needs." },
    { icon: <TrendingUp className="w-8 h-8 text-cap-yellow" />, title: "Pay equity & transparency", desc: "Ensure fair and equitable compensation across all demographics with full audit trails." },
    { icon: <Award className="w-8 h-8 text-cap-yellow" />, title: "Total rewards communication", desc: "Help employees understand and value their complete compensation and benefits package." },
  ];
