...
const LabourLaw = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Shield className="w-8 h-8 text-cap-yellow" />, title: "100% statutory compliance", desc: "Zero-miss guarantee on all PF, ESI, PT, LWF, and other statutory filings across all states." },
    { icon: <Scale className="w-8 h-8 text-cap-yellow" />, title: "Legally sound policies", desc: "HR policies that are compliant with current laws, POSH Act, and new labour codes." },
    { icon: <FileCheck className="w-8 h-8 text-cap-yellow" />, title: "Audit-ready documentation", desc: "Complete audit trails for every compliance action — ready for inspection at any time." },
    { icon: <AlertTriangle className="w-8 h-8 text-cap-yellow" />, title: "Risk mitigation", desc: "Proactive identification and resolution of compliance risks before they become liabilities." },
    { icon: <Gavel className="w-8 h-8 text-cap-yellow" />, title: "Labour code readiness", desc: "Full preparation for India's new labour codes with impact analysis and transition support." },
  ];
