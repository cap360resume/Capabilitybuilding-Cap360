...
const OrgDesign = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <LayoutGrid className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Agile organisation structures", desc: "Design structures that enable fast decision-making, clear accountability, and strategic alignment." },
    { icon: <Users className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Optimised workforce sizing", desc: "Right-size teams based on workload analysis, productivity benchmarks, and growth projections." },
    { icon: <GitBranch className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Smooth transformations", desc: "Navigate restructuring, M&A integrations, and operating model changes with minimal disruption." },
    { icon: <TrendingUp className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Future-ready capabilities", desc: "Map current skills against future needs and build targeted capability development roadmaps." },
    { icon: <Search className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-yellow" />, title: "Data-driven decisions", desc: "Use workforce analytics to inform org design choices with evidence, not assumptions." },
  ];
