...
const LearningExperienceDesign = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <BookOpen className="w-8 h-8 text-cap-blue" />, title: "Outcome-driven curricula", desc: "Learning paths designed backwards from business outcomes to skill requirements." },
    { icon: <Monitor className="w-8 h-8 text-cap-blue" />, title: "Engaging digital experiences", desc: "Interactive, scenario-based e-learning that drives real skill development." },
    { icon: <Gamepad2 className="w-8 h-8 text-cap-blue" />, title: "Gamified learning journeys", desc: "Game mechanics that boost engagement, completion, and knowledge retention." },
    { icon: <BarChart3 className="w-8 h-8 text-cap-blue" />, title: "Learning analytics & ROI", desc: "Measure learning effectiveness with data on engagement, skills, and business impact." },
    { icon: <Sparkles className="w-8 h-8 text-cap-blue" />, title: "AI-personalised learning", desc: "Adaptive paths that adjust to individual pace, preferences, and learning style." },
  ];
