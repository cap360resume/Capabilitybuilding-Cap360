...
const InnovationDesignThinking = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Lightbulb className="w-8 h-8 text-cap-blue" />, title: "Design thinking capability", desc: "Embed human-centered design as a core problem-solving approach across the organisation." },
    { icon: <Rocket className="w-8 h-8 text-cap-blue" />, title: "Internal innovation pipeline", desc: "Create structured pathways from idea to implementation with intrapreneurship programmes." },
    { icon: <FlaskConical className="w-8 h-8 text-cap-blue" />, title: "Experimentation culture", desc: "Build a fail-fast, learn-fast culture that accelerates innovation velocity." },
    { icon: <Palette className="w-8 h-8 text-cap-blue" />, title: "Creative problem-solving", desc: "Equip teams with lateral thinking and structured creativity techniques." },
    { icon: <Zap className="w-8 h-8 text-cap-blue" />, title: "Innovation ROI", desc: "Measure and demonstrate the business impact of innovation investments." },
  ];
