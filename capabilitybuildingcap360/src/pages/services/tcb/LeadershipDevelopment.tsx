...
const LeadershipDevelopment = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Crown className="w-8 h-8 text-cap-blue" />, title: "Strategic executive capability", desc: "Senior leaders equipped to navigate complexity, drive transformation, and create long-term organisational value." },
    { icon: <Users className="w-8 h-8 text-cap-blue" />, title: "Strong leadership pipeline", desc: "Emerging leaders prepared for increased responsibility through structured, accelerated development programmes." },
    { icon: <Target className="w-8 h-8 text-cap-blue" />, title: "Measurable leadership impact", desc: "Demonstrated behaviour change and business outcomes tracked through robust impact measurement frameworks." },
    { icon: <Layers className="w-8 h-8 text-cap-blue" />, title: "Embedded leadership culture", desc: "A self-reinforcing leadership ecosystem where development is continuous, social, and aligned to strategy." },
    { icon: <Award className="w-8 h-8 text-cap-blue" />, title: "Enhanced talent retention", desc: "Higher engagement and retention of top talent through visible investment in leadership growth." },
  ];
