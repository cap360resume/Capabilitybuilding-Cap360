...
const TeamEffectiveness = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Users className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-blue" />, title: "High-performing teams", desc: "Build cohesive teams with clear roles, shared accountability, and trust-based dynamics." },
    { icon: <MessageSquare className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-blue" />, title: "Open feedback culture", desc: "Create psychological safety where honest communication drives continuous improvement." },
    { icon: <Handshake className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-blue" />, title: "Cross-functional alignment", desc: "Break silos with shared objectives and structured collaboration frameworks." },
    { icon: <Zap className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-blue" />, title: "Agile team dynamics", desc: "Equip teams with agile ways of working for faster delivery and adaptation." },
    { icon: <Target className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-cap-blue" />, title: "Measurable team outcomes", desc: "Track team effectiveness with diagnostics, pulse surveys, and performance metrics." },
  ];
