...
const CompetencyAssessments = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Target className="w-8 h-8 text-cap-red" />, title: "Validated competency frameworks", desc: "Organisation-specific competency models aligned to strategy, culture, and role requirements for accurate talent assessment." },
    { icon: <ClipboardList className="w-8 h-8 text-cap-red" />, title: "Objective talent evaluation", desc: "Multi-method assessments that eliminate bias and deliver reliable, comparable competency data across the workforce." },
    { icon: <BarChart3 className="w-8 h-8 text-cap-red" />, title: "Data-driven talent decisions", desc: "Rich analytics and heatmaps that inform succession planning, talent reviews, and strategic workforce investments." },
    { icon: <CheckCircle className="w-8 h-8 text-cap-red" />, title: "Targeted development plans", desc: "Personalised development roadmaps based on assessed competency gaps, linked to business-critical capability needs." },
    { icon: <Layers className="w-8 h-8 text-cap-red" />, title: "Scalable assessment solutions", desc: "Digital and in-person assessment platforms that scale from team-level evaluations to enterprise-wide programmes." },
  ];
