...
const TalentAnalytics = () => {
  ...
  // ─── Infinite carousel ────────────────────────────────────────────────────
  const cards = [
    { icon: <Database className="w-8 h-8 text-cap-red" />, title: "Unified talent data platform", desc: "Integrated HR data from multiple sources providing a single view of your workforce and talent pipeline." },
    { icon: <TrendingUp className="w-8 h-8 text-cap-red" />, title: "Predictive workforce insights", desc: "Anticipate attrition, performance trends, and skills gaps before they impact business outcomes." },
    { icon: <BarChart3 className="w-8 h-8 text-cap-red" />, title: "Competitive benchmarking", desc: "Understand how your talent practices compare to market peers for strategic positioning." },
    { icon: <PieChart className="w-8 h-8 text-cap-red" />, title: "Executive-ready dashboards", desc: "Visual analytics that communicate workforce insights to leadership in clear, actionable formats." },
    { icon: <Shield className="w-8 h-8 text-cap-red" />, title: "Data-driven talent strategy", desc: "Transform talent management from reactive to strategic with evidence-based decision frameworks." },
  ];
